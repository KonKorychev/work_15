# Поиск оптимальной стратегии в среде Taxi-v3
Реализовать алгоритм поиска оптимальной стратегии Q-learning. Получив оптимальную стратегию сыграть 10 000 эпизодов и вывести оценку стратегии в виде средней награды за все игры и количество побед. Визуализировать один эпизод игры с оптимальной стратегией.
